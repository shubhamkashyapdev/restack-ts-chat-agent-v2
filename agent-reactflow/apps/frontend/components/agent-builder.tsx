      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            >
              {showWorkflowSelector ? (
                <Workflow className="h-5 w-5 opacity-50" />
              ) : (
        ...
        {viewMode === "flow" ? (
          <div className="relative flex-1">
            ...
            {showWorkflowSelector && (
              <WorkflowSelector onClose={toggleWorkflowSelector} />
            )}
          </div>
        ) : (
          <div className="relative flex-1">
            <div className="h-full w-full overflow-auto p-4 space-y-4">
              ...
              <pre className="text-xs p-4 bg-neutral-100 dark:bg-neutral-900 rounded-md">
                {exportToJson()}
              </pre>
            </div>
          </div>
